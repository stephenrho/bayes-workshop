...
Given an model formula you can find the parameters to set priors for via (below are the defaults used by brms):
...
```{r, echo=F}
hist(m3_days, breaks = 30, border = F, col="lightblue", main="Change in Reaction per  (m3)", xlab="", ylab="", axes=F)
axis(1)
